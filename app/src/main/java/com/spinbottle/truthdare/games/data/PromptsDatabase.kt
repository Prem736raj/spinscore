...
object PromptsDatabase {
    ...
    private fun addKidsFamilyDares() {
        ...
        val kidsDares = listOf(
            ...
            "Pretend you are walking on the moon for 15 seconds",
    ...
    private fun addCouplesDares() {
        ...
        val wildDares = listOf(
            ...
            "Pretend to be a makeup artist and describe a silly imaginary look without touching anyone",
            ...
            "Do a 20-second goofy standing dance",
            "Draw a tiny silly doodle on paper and hold it beside your face",
            ...
            "Do an overdramatic fully clothed runway dance",
            "Make up a fake status update and read it aloud without posting it",
            "Invent a fictional detective target and explain the silly case",
            "Do a body roll against a wall",
            "Describe an embarrassing photo memory without showing your device",
            "Let the group suggest a harmless accessory or pose, and choose one you are comfortable with",
            ...
            "Do a 20-second playful dance while making a dramatic movie-star face",
    ...
    private fun addPartyDares() {
        ...
        val easyDares = listOf(
            ...
            "Create a dramatic movie-poster pose",
            "Yell everything you say for one round",
            "Do five slow superhero poses",
        ...
        val mediumDares = listOf(
            ...
            "Describe the most over-the-top imaginary makeover you can invent",
            ...
            "Show a harmless skill or party trick you enjoy"
        )
        ...
        val hardDares = listOf(
            ...
            "Let the group invent a harmless dare that avoids pain, privacy, spending, substances, and third parties",
            "Be the group's over-the-top announcer for one round",
            "Invent three fictional group-chat messages and read them dramatically",
            ...
            "Let the group suggest two harmless poses and choose your favorite",
            ...
            "Choose one harmless group suggestion that you are comfortable performing",
            "Do ten seconds of air guitar",
            "Choose one harmless group suggestion that you are comfortable doing for 30 seconds",
            "Invent a harmless fictional secret about an imaginary character",
            "Hold a comfortable superhero pose for 15 seconds",
            "Create a fake headline about tonight's game",
            "Draw a tiny imaginary mascot on paper and give it a name",
            ...
            "Name an artist or song you enjoy without opening any account",
            "Do your most embarrassing talent",
            "Invent a ridiculous imaginary product under $5 and give it a sales pitch",
    ...
    private fun addStudentsTruths() {
        ...
        val studentTruths = listOf(
            ...
            "What's the best part of having time off from school?",
    ...
    private fun addFriendsTruths() {
        ...
        val easyTruths = listOf(
            ...
            "What's a harmless topic you've been curious about lately?",
            "Which celebration or festival do you look forward to most?",
            "If you had to choose one cuisine for a month, what would you pick?",
            ...
            "What dessert flavor do you almost always choose?",
            "What's the best advice you've ever received?",
            "Which tabletop game would you teach a new player?",
        ...
        val hardTruths = listOf(
            ...
            "What kind of social-media content do you usually enjoy?",
